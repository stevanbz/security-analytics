...
public class TransportIndexDetectorAction extends HandledTransportAction<IndexDetectorRequest, IndexDetectorResponse> implements SecureTransportAction {
    ...
    private void checkAndDeleteRuleIndices(List<String> ruleIndices, ActionListener<AcknowledgedResponse> listener) {
        ...
        ActionListener<AcknowledgedResponse> onDeleteRuleTopicIndexListener = new GroupedActionListener<>(
            new ActionListener<>() {
                @Override
            ...
            ruleTopicIndices.countQueries(ruleIndex, new ActionListener<>() {
                ...
                public void onResponse(SearchResponse searchResponse) {
                    if (searchResponse.isTimedOut()) {
                        ...
                        onDeleteRuleTopicIndexListener.onResponse(new AcknowledgedResponse(true));
                    } else {
